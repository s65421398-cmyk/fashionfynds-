...
export default function ContactPage() {
  ...
  const contactMethods = [
    ...
    },
    {
      icon: MapPin,
      title: "Visit Us",
      content: "123 Fashion Avenue, Mumbai, MH 400001",
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="bg-linear-to-br from-teal-50 to-white py-12">
            ...
            <div className="max-w-5xl mx-auto">
                ...
                {contactMethods.map((method, index) => {
                  ...
                  return (
                    <a
                      key={index}
                      href={method.action}
                      className="bg-linear-to-br from-teal-50 to-white rounded-xl p-6 border hover:shadow-lg transition-all group"
                    >
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    {submitted ? (
                      ...
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                          type="submit"
                          disabled={submitting}
                          className="w-full bg-[#1BA6A6] text-white py-3 rounded-lg font-semibold hover:bg-teal-600 transition-colors flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                ...
                <div className="space-y-6">
                  {/* Business Hours */}
                  <div className="bg-linear-to-br from-teal-50 to-white rounded-2xl p-6 border">
                  ...
                  {/* FAQ Link */}
                  <div className="bg-linear-to-br from-purple-50 to-white rounded-2xl p-6 border">
                  ...
                  {/* Order Support */}
                  <div className="bg-linear-to-br from-orange-50 to-white rounded-2xl p-6 border">
